"""Generate an executable pytest summary for Cycle 40."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=ROOT / "reports" / "generated" / "cycle_40_test_summary.json",
    )
    args = parser.parse_args()
    collected_output = _pytest("--collect-only")
    execution_output = _pytest()
    summary = {
        "schema_version": "cycle40-pytest-summary-v1",
